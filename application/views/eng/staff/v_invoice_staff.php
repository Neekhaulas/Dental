            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-hover cell-border table-bordered" id="dataTables">
                            <thead>
                            <tr>
                    ...
                    <div class="text-right">
                        <a href="<?= site_url('/Staff_c/unpaidInvoices');?>"><?= $this->lang->line('get-unpaid-invoices'); ?> <i class="fa fa-arrow-circle-right"></i></a>
                        <a href="<?= site_url('/Staff_c/paidInvoices');?>"><?= $this->lang->line('get-paid-invoices'); ?> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    <!-- /.table-responsive -->
                </div>
                <!-- /.panel-body -->
