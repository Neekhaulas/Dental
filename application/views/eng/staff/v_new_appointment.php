<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <?= $this->lang->line('new-appointment'); ?>
                </h1>
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <label for="hour_appointment" ><?= $this->lang->line('date_hour'); ?></label>
        ...
        <div class="col-lg-6">
            ...
            <select class="form-control" name="patient_appointment">
                <?php foreach ($patients as $key=>$value) : ?>
                    <option value="<?php echo $key; ?>" <?php if($key==set_value('patient')) echo 'selected' ;?>>
                        <?= $value ?>
                    </option>
                <?php endforeach; ?>
            </select>
