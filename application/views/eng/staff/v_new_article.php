<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-8 col-lg-offset-2">
            <h2 class="page-header"><?= $this->lang->line('write-article'); ?></h2>
            ...
            <div class="form-group">
                ...
                <textarea id="content_article" name="content_article"><?= set_value('content_article')?></textarea>
            </div>
