<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="form-group">
                <label for="treatment_name"><?= $this->lang->line('price'); ?></label>
                <input type="text" class="form-control" name="treatment_price" id="login" value="<?= set_value('treatment_price',$treatment_price);?>">
            </div>
