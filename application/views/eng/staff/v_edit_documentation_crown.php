    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-lg-offset-6">
                <a href="<?= site_url('/Staff_c/documentationCrown');?>">
        ...
        <!-- FORM -->
        <?php echo form_open('Staff_c/confirmEditDocumentationCrown') ?>
        <div class="col-lg-8 col-lg-offset-2">
            <h2 class="page-header"><?= $this->lang->line('edit-crown-documentation'); ?></h2>
