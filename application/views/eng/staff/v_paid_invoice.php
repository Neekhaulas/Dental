    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-list fa-fw"></i> <?= $this->lang->line('paid-invoices'); ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="text-right">
                        <a href="<?= site_url('/Staff_c/invoiceStaff');?>"><?= $this->lang->line('get-all-invoices'); ?> <i class="fa fa-arrow-circle-right"></i></a>
